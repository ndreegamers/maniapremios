    ...
    <main className="flex-1 flex flex-col">
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 py-8 flex flex-col gap-8">
        ...
        <div className="flex items-center gap-4">
          <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#1C1F27] to-transparent" />
          <span className="text-[#262A34] text-xs">·</span>
          <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#1C1F27] to-transparent" />
        </div>
        ...
        {loading ? (
          ...
          >
            <Trophy className="w-12 h-12 text-[#262A34]" />
            <div>
              <p className="text-[#8A90A0] text-sm">
                Aún no hay ganadores registrados.
              </p>
              <p className="text-[#8A90A0]/50 text-xs mt-1">
                Los ganadores aparecerán aquí tras completarse un sorteo.
              </p>
            </div>
            <Link
              href="/"
              className="mt-2 flex items-center gap-2 bg-[#2E6BFF] text-[#08090C] font-semibold text-sm rounded-md px-5 py-2 transition-all hover:bg-[#4F7FFF]"
            >
              Ver sorteos activos
            </Link>
          </motion.div>
